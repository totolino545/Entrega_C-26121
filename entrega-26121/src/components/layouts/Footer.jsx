...
const Footer = () => {
  ...
  return (
    ...
    <footer className="m-2 rounded-2xl bg-teal-900 shadow-md">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 border-gray-200 ">
        <div className="flex justify-center items-center text-teal-600 dark:text-teal-300 gap-4">
          ...
          <p className="text-base font-medium text-gray-300 text-sm">
            © {currentYear}
            <span className="bg-clip-text mx-2 text-transparent bg-gradient-to-r from-yellow-400 to-pink-400">
              TechStore
            </span>
        ...
        <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          ...
          <li>
            <Link to="/contacto" className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75">
              Contacto
            </Link>
          </li>
